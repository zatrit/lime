...
class AndroidPlatform extends PlatformTarget
{
	...
	public override function update():Void
	{
		...
		context.ANDROID_GRADLE_VERSION = project.config.getString("android.gradle-version", "7.4");
		context.ANDROID_GRADLE_PLUGIN = project.config.getString("android.gradle-plugin", "7.1.2");
